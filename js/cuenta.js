...
$("#saveNuevaContra").click(function(){
	if(Verificacontra() && Verificacontra2()){
		console.log("entra");
		$.post('../php/contra.php',{contra:$("#contra").val()})
		.done(function(data,textStatus,jqXHR){
			console.log("Solicitud se ha completado correctamente "+ textStatus);
			console.log(data);
			if(data!="bad"){
		...
		.always(function(data,textStatus,jqXHR){
			console.log("../php/cambiarcuenta.php")
		})
	}else{
...
$("#editar").click(function(){
	...
	if(Verificadireccion() && Verificatelf()){
		$.post('../php/updatecuenta.php',{direccion:$("#direc").val(), telf:$("#tel").val()})
		.done(function(data,textStatus,jqXHR){
...
$("#eliminarcuenta").click(function(){
	...
	$.post('../php/eliminarcuenta.php',{direccion: $("#direc").val(), telf:$("#tel").val()})
	.done(function(data,textStatus,jqXHR){
...
location.replace("../php/logout.php")
	...
	.always(function(data,textStatus,jqXHR){
		console.log("../php/updatecuenta.php")
	})
})
