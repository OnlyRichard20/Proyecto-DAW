...
<html lang="es">
  <head>
    ...
    <title>Página de profesionales que hay en la web</title>

    <!--CSS-->
    <link href="../css/proyectofinal.css" rel="stylesheet" type="text/css">
    <link href="../css/profesionales.css" rel="stylesheet" type="text/css">
  ...
  <body>
    ...
    <!--Segundo container fluid-->
              ...
              <header>
                ...
                <nav>
                  <ul>
                    ...
                    <li><a href="#"><span class="icon-profile"></span>PROFESIONALES</a></li>
      ...
      <div class="profesionales container-fluid">
              <div class="profesional container">
                <div class="filaProfesionales row">
                  <?php foreach ($resultado2 as $row) { ?>
                  <div class="columnaProfesionales col-8 col-sm-8 col-md-8">
                    <div class="filaDentro row">
               
                            <div class="columnaFoto col-4 col-sm-4 col-md-4">
                                   <img src="../imagenes/fotos/<?php echo $row['imagen']; ?>" alt="#">
                                   
                            </div>
                           
                           
                            <div class="columnaDatos col-8 col-sm-8 col-md-8"></div>
