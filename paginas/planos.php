...
<html lang="es">
  <head>
    ...
    <title>Página de planos con la galeria de planos que hay en la web</title>
    ...
    <!--Segundo container fluid-->
      ...
      <div class="planos container-fluid">
              <div class="plano container">
                <div class="filaPlanos row">
                  <?php foreach ($resultado as $row) { ?>
                  <div class="columnaPlanos col-4 col-sm-4 col-md-4">
                    <img src="../imagenes/planos/<?php echo $row['plano']; ?>" alt="#">
                    <p class="titulo"><strong><?php echo $row['titulo']; ?></strong></p>
                  </div>
                  <?php }?>
